          ...
          <div class="container-fluid">
            ...
            <div class="navbar-header">
              ...
              <a class="logo" href="index.html">
                <img
                  class="logo-light"
                  src="assets/images/logo/g2logo-rb.png"
                  alt="Land Logo"
                />
                <img class="logo-dark" src="assets/images/logo/g2logo-rb.png" />
              </a>
            </div>
            ...
            >
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown-submenu">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li>
                          <a href="properties-grid-split.html"
                            >properties grid split</a
                          >
                        </li>
                      </ul>
                    </li>
                    <li class="dropdown-submenu">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li>
                          <a href="properties-list-split.html"
                            >properties list split</a
                          >
                        </li>
                      </ul>
                    </li>
                    <li class="dropdown-submenu">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li>
                          <a href="property-single-slider.html"
                            >single slider</a
                          >
                        </li>
                      </ul>
              ...
              <div class="module module-property pull-left">
                <a href="add-property.html" target="_blank" class="btn"
                  ><i class="fa fa-plus"></i> add property</a
                >
              </div>
            </div>
            <!-- /.navbar-collapse -->
          ...
          <div class="row mb-50">
              ...
              <div class="blog-entry">
                ...
                <div class="entry--content">
                  <div class="entry--meta">
                    <a href="#">March 09, 2022</a><a href="#">3 Comments</a>
                  </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="blog-entry">
                ...
                <div class="entry--content">
                  <div class="entry--meta">
                    <a href="#">March 15, 2022</a><a href="#">7 Comments</a>
                  </div>
                  <div class="entry--title">
                    <h4><a href="#">Marketing Ideas to Sell a Listing</a></h4>
                  </div>
                  <div class="entry--bio">
                    Many Realtors, like most companies, continue to market their
                    businesses
                  </div>
                  <div class="entry--more">
                    <a href="#"
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="blog-entry">
                ...
                <div class="entry--content">
                  <div class="entry--meta">
                    <a href="#">April 05, 2022</a><a href="#">2 Comments</a>
                  </div>
                  <div class="entry--title">
                    <h4><a href="#">Effective Real Estate Websites</a></h4>
                  </div>
                  <div class="entry--bio">
                    In other words, if you’re not tracking your real estate
                    website’s analytics to follow
                  </div>
                  <div class="entry--more">
                    <a href="#"
                      >Read More<i class="fa fa-angle-double-right"></i
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="blog-entry">
                ...
                <div class="entry--content">
                  <div class="entry--meta">
                    <a href="#">June 21, 2022</a><a href="#">1 Comments</a>
                  </div>
                  <div class="entry--title">
                    <h4><a href="#">How to Make a Viral Video</a></h4>
                  </div>
                  <div class="entry--bio">
                    A viral video is one that creatively promotes a property,
                    real estate company
                  </div>
                  <div class="entry--more">
                    <a href="#"
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="blog-entry">
                ...
                <div class="entry--content">
                  <div class="entry--meta">
                    <a href="#">June 26, 2022</a><a href="#">4 Comments</a>
                  </div>
                  <div class="entry--title">
                    <h4><a href="#">Creating a Captive Audience</a></h4>
                  </div>
                  <div class="entry--bio">
                    More real estate companies and agents are finally
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="blog-entry">
                ...
                <div class="entry--content">
                  <div class="entry--meta">
                    <a href="#">October 17, 2022</a><a href="#">2 Comments</a>
                  </div>
                  <div class="entry--title">
                    <h4><a href="#">Real Estate Email Marketing</a></h4>
                  </div>
                  <div class="entry--bio">
                    As a Realtor, you are constantlylooking for new and improved
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="blog-entry">
                <div class="entry--img">
                  <a href="#">
                    <img
                      src="assets/images/blog/grid/7.jpg"
                      alt="entry image"
                    />
                  </a>
                </div>
                <div class="entry--content">
                  <div class="entry--meta">
                    <a href="#">October 12, 2022</a><a href="#">3 Comments</a>
                  </div>
                  <div class="entry--title">
                    <h4><a href="#">How to Get a Mortgage</a></h4>
                  </div>
                  <div class="entry--bio">
                    The growing number of gig economy workers in this country
                    may have freedom
                  </div>
                  <div class="entry--more">
                    <a href="#"
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="blog-entry">
                <div class="entry--img">
                  <a href="#">
                    <img
                      src="assets/images/blog/grid/8.jpg"
                      alt="entry image"
                    />
                  </a>
                </div>
                <div class="entry--content">
                  <div class="entry--meta">
                    <a href="#">January 09, 2022</a><a href="#">3 Comments</a>
                  </div>
                  <div class="entry--title">
                    <h4><a href="#">5 Ways to Boost Neighborhood</a></h4>
                  </div>
                  <div class="entry--bio">
                    One of the easiest ways to get information and updates from
                    the people who live..
                  </div>
                  <div class="entry--more">
                    <a href="#"
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="blog-entry">
                <div class="entry--img">
                  <a href="#">
                    <img
                      src="assets/images/blog/grid/9.jpg"
                      alt="entry image"
                    />
                  </a>
                </div>
                <div class="entry--content">
                  ...
                  <div class="entry--title">
                    <h4><a href="#">3 Key Tips for Selling a Home</a></h4>
                  </div>
                  <div class="entry--bio">
                    To environmentally conscious homebuyers, eco-friendly
                    features can help your home.
                  </div>
                  <div class="entry--more">
                    <a href="#"
                      >Read More<i class="fa fa-angle-double-right"></i
...
============================================= -->
      <section
        id="cta"
        class="cta cta-1 text-center bg-overlay bg-overlay-dark pt-90"
      >
        <div class="bg-section">
        ...
        <div class="footer-widget">
          <div class="container">
            <div class="row">
                ...
                <div class="widget--content">
                  ...
                  <div class="footer--contact">
                    <ul class="list-unstyled mb-0">
                      ...
                      <li>
                        <a href="mailto:contact@land.com">contact@land.com</a>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <!-- .col-md-2 end -->
              <div
                class="col-xs-12 col-sm-3 col-md-2 col-md-offset-1 widget--links"
              >
          ...
          <div class="container">
            <div class="row footer--bar">
              <div class="col-xs-12 col-sm-12 col-md-12">
                <span
                  >© 2022
                  <a href="http://themeforest.net/user/CSE 20 G-2 "
                    >CSE 20 G-2 </a
